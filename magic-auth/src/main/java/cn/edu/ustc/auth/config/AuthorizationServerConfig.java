package cn.edu.ustc.auth.config;

import cn.edu.ustc.auth.extension.captcha.CaptchaTokenGranter;
import cn.edu.ustc.auth.extension.mobile.SmsCodeTokenGranter;
import cn.edu.ustc.auth.extension.refresh.PreAuthenticatedUserDetailsService;
import cn.edu.ustc.auth.extension.wechat.WechatTokenGranter;
import cn.edu.ustc.auth.userdetails.member.MemberUserDetailsServiceImpl;
import cn.edu.ustc.auth.userdetails.user.SysUserDetailsServiceImpl;
