...
package cn.edu.ustc.file.office.mappers;

import cn.edu.ustc.file.office.entities.Permission;
...
@Component
@Primary
public class PermissionsMapper extends AbstractMapper<Permission, cn.edu.ustc.file.office.documentserver.models.filemodel.Permission> {
    @Autowired
    private ModelMapper mapper;

    public PermissionsMapper() {
        super(cn.edu.ustc.file.office.documentserver.models.filemodel.Permission.class);
    }

    @PostConstruct
    public void configure() {  // configure the permission mapper
        mapper.createTypeMap(Permission.class, cn.edu.ustc.file.office.documentserver.models.filemodel.Permission.class)  // create the type map
                .setPostConverter(modelConverter());  // and apply the post converter to it
    }

    @Override
    void handleSpecificFields(Permission source, cn.edu.ustc.file.office.documentserver.models.filemodel.Permission destination) {  // handle specific permission fields
